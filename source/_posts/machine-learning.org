...
\begin{equation}
P \left( \left| R(h) - \hat{R}(h) \right| > \epsilon \right) \leq 4\prod_{\mathcal{H}} (2m) exp(- \frac{m\epsilon^2}{8})
\end{equation}
...
\begin{equation}
P \left( \left| \varepsilon(h) - \hat{R}(h) \right| \leq \sqrt{\frac{8dln\frac{2em}{d} + 8ln\frac{4}{\delta}}{m}} \right) \geq 1 -
\delta
\end{equation}
